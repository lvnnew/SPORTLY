      ...
      >
        <Grid item xs={12} md={6}>
          <TextField
            ...
            label="Имя"
            variant="standard"
            sx={{ width: "100%", padding: "10px 0", pt: "0px" }}
          />
        </Grid>
        <Grid item xs={12} md={6}>
          <TextField
        ...
        Оставляя заявку, вы даете нам разрешение связаться с вами и соглашаетесь с <Link href="/politics">Политикой конфиденциальности</Link>
        </Typography>
        </Grid>
        <Grid item xs={12} md={6} sx={{
